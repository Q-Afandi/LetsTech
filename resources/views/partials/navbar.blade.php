    ...
    <nav class="flex justify-between bg-primary text-white w-screen">
      <div class="px-5 xl:px-12 py-6 flex w-full items-center">
        ...
        <ul class="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
          ...
          <li><a class="hover:text-gray-200" href="#">Cara Kerja</a></li>
          <li><a class="hover:text-gray-200" href="#">Testimoni</a></li>
          <li><a class="hover:text-gray-200" href="#">Handphone</a></li>
        </ul>
        <!-- Header Icons -->
