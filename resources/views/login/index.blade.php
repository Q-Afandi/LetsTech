          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" action="/login" method="post">
                @csrf
                  ...
                  <p class="justify-center text-gray-50 mx-48">
                    Or
                  </p>
                  {{-- Google --}}
                  <div class="flex flex-row justify-start w-80 mx-10 p-2">
                    <a href="{{ route('google.login') }}" class="flex w-full  bg-gray-500  text-white bg-primary-600 hover:bg-white hover:text-black font-medium rounded-lg text-sm px-5 py-2.5">
                      <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48" class="w-8 h-8">
