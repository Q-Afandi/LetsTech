...
<body>
    ...
    <div class=" bg-white mx-4 lg:mx-20 mt-10 rounded-2xl flex flex-1 max-w-full lg:max-h-100 items-center justify-between p-4" aria-label="Global">
    ...
    <form>
    <div class=" bg-white py-2  mx-4 lg:mx-64 mt-5 rounded-2xl  lg:max-h-100 items-center justify-between p-4 " aria-label="Global">   
